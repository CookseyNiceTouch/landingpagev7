    ...
    <div className="content-page">
      ...
      <FadeIn>
        <div
          ...
          style={{ maxWidth: '52rem', marginInline: 'auto', marginBottom: '4rem', pointerEvents: 'auto' }}
        >
          ...
          <p style={{ fontFamily: 'var(--font-body)', fontSize: '0.9375rem', lineHeight: 1.75, color: 'rgba(255,255,255,0.55)', margin: 0 }}>
            {PRIVACY_CONTACT.body}{' '}
            <a
              href={`mailto:${PRIVACY_CONTACT.email}`}
              style={{ color: 'var(--color-yellow)', textDecoration: 'none' }}
            >
              {PRIVACY_CONTACT.email}
            </a>
            .
          </p>
          <p style={{ fontFamily: 'var(--font-body)', fontSize: '0.875rem', lineHeight: 1.7, color: 'rgba(255,255,255,0.35)', marginTop: '0.75rem' }}>
            {PRIVACY_CONTACT.ico}
          </p>
          <p style={{ fontFamily: 'var(--font-body)', fontSize: '0.8125rem', color: 'rgba(255,255,255,0.25)', marginTop: '1.25rem' }}>
