...
function ExportQC(): ReactElement {
  const workflowContent = content.workflowsDetail.exportQC
  const workflowSEO = seoData.workflowsDetail.exportQC
